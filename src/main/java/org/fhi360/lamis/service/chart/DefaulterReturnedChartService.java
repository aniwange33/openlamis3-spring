 ...
 */
@Component
public class DefaulterReturnedChartService {
    private JDBCUtil jdbcUtil;


    public DefaulterReturnedChartService() {
            ...
            if (resultSet != null) {
                while (resultSet.next()) {
                    ...
                    if (dataElementId == 47) {
                        ...
                        //System.out.println(".....defaulters:"+resultSet.getInt("value"));
                    } else {
                        map.put("value2", resultSet.getInt("value"));
                        // System.out.println(".....returned:"+resultSet.getInt("value"));
                    }
                }
            }
