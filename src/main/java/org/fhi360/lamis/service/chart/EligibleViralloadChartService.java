 ...
 */
@Component
public class EligibleViralloadChartService {
    private JDBCUtil jdbcUtil;

    public EligibleViralloadChartService() {
            ...
            if (resultSet != null) {
                while (resultSet.next()) {
                    ...
                    if (dataElementId == 41) {
                        ...
                        //System.out.println(".....eligible:"+resultSet.getInt("value"));
                    } else {
                        map.put("value2", resultSet.getInt("value"));
                        // System.out.println(".....test done:"+resultSet.getInt("value"));
                    }
                }
            }
