 ...
 */
@Component
public class ViralSuppressedChartService {

    private JDBCUtil jdbcUtil;

    public ViralSuppressedChartService() {
            ...
            if (resultSet != null) {
                while (resultSet.next()) {
                    ...
                    if (dataElementId == 16) {
                        ...
                        System.out.println(".....viral test result recieved:" + resultSet.getInt("value"));
                    } else {
                        map.put("value2", resultSet.getInt("value"));
                        System.out.println(".....virally suppressed:" + resultSet.getInt("value"));
                    }
                }
            }
