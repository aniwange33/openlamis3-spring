 ...
 */
@Component
public class EnrolledStartedChartService {
    private JDBCUtil jdbcUtil;

    public EnrolledStartedChartService() {
            ...
            if (resultSet != null) {
                while (resultSet.next()) {
                    ...
                    if (dataElementId == 1) {
                        ...
                        //System.out.println(".....newly enrolled:"+resultSet.getInt("value"));
                    } else {
                        map.put("value2", resultSet.getInt("value"));
                        //System.out.println(".....Started:"+resultSet.getInt("value"));
                    }
                }
            }
