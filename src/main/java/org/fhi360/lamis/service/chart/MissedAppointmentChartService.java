 ...
 */
@Component
public class MissedAppointmentChartService {
    private JDBCUtil jdbcUtil;

    public MissedAppointmentChartService() {
            ...
            if (resultSet != null) {
                while (resultSet.next()) {
                    ...
                    if (dataElementId == 46) {
                        ...
                        //System.out.println(".....scheduled appointment:"+resultSet.getInt("value"));
                    } else {
                        map.put("value2", resultSet.getInt("value"));
                        //System.out.println(".....missed:"+resultSet.getInt("value"));
                    }
                }
            }
