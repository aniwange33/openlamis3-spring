 ...
 */
@Component
public class CurrentOnArtRegimenChartService {

    private JDBCUtil jdbcUtil;

    public CurrentOnArtRegimenChartService() {

    }

    public Map<String, Object> getChartData(long ipId, long stateId, long lgaId, long facilityId, String dataElementIds, Date reportingDateBegin) {
            ...
            if (resultSet != null) {
                while (resultSet.next()) {
                    ...
                    if (dataElementId == 10) {
                        ...
                        //System.out.println(".....Current on ART:"+resultSet.getInt("value"));
                    } else {
                        map.put("value2", resultSet.getInt("value"));
                        //System.out.println(".....TLD:"+resultSet.getInt("value"));
                    }
                }
            }
    ...
    public Map<String, Object> getChartDataByMonth(long ipId, long stateId, long lgaId, long facilityId, String dataElementIds, int month, int year) {
