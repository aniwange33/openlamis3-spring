...
@Component
public class TreatmentTrackerConverter implements ServletContextAware {
    ...
    public TreatmentTrackerConverter() {

    }

    public synchronized ByteArrayOutputStream convertExcel(Long userId, String facilityIds, String state, String reportingDateBegin, String reportingDateEnd) {
        ...
        try {
            ...
            query = "SELECT DISTINCT patient.facility_id, facility.name FROM patient JOIN facility ON " +
                    "patient.facility_id = facility.facility_id WHERE patient.facility_id IN (" + facilityIds + ")" +
            ...
            while (resultSet.next()) {
                ...
                String dateBegin = reportingDateBegin;
                String dateEnd = reportingDateEnd;

                query = "SELECT current_status, date_started, last_viral_load, viral_load_due_date FROM patient" +
                        " WHERE facility_id = " + facilityId + " AND date_started >= '" + dateBegin +
                        "' AND date_started <= '" + dateEnd + "' AND current_status IS NOT NULL";
                preparedStatement = jdbcUtil.getStatement(query);
