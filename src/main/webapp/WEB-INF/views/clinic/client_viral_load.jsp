<%-- 
    Document   : client_viral_load
    Created on : Oct 27, 2017, 11:57:38 AM
    Author     : user10
--%>
    ...
    <script type="text/JavaScript">
        ...
        $(document).ready(function () {
            ...
            $("#ok_button").bind("click", function (event) {
                ...
                url = "Client_viral_load_report.action?" + url;
                window.open(url);
                return false;
            });
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Case Manager Clients due for Viral Load Test</li>
    </ol>
</nav>
<div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-group">Facility Case Manager:</label>
