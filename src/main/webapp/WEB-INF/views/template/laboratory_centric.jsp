...
<div class="content col-12 mr-auto ml-auto">
    ...
    <form id="lamisform" theme="css_xhtml">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">General Lab</div>
                    <div class="card-body">
                        <input id="tab1" type="radio" name="tabs" checked>
                        <label for="tab1">Laboratory Test</label>

                        <input id="tab2" type="radio" name="tabs">
                        <label for="tab2">Laboratory Test Orders</label>

                        <section id="content1">
                            <!-- Drug Dispensing -->
                            <div class="row">
                                <div class="col-6">
                                    <button onclick="newTest();" class="btn btn-info">New</button>
                                </div>
                                <div class="col-6">
                        ...
                        <section id="content2">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <button onclick="newOrder();" class="btn btn-info">New</button>
                                </div>
                                <div class="col-6">
                                    <div class="input-group no-border col-6 pull-right">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="table-responsive">
                                        <table id="order" class="table table-striped"></table>
                                    </div>
                                </div>
                            </div>
                        </section>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">Auto Lab</div>
                    <div class="card-body">
                        <input id="tab1a" type="radio" name="tabs" checked>
                        <label for="tab1a">Sample Registration</label>

                        <input id="tab2a" type="radio" name="tabs">
                        <label for="tab2a">Result Processing</label>

                        <input id="tab3a" type="radio" name="tabs">
                        <label for="tab3a">Dispatch Result</label>

                        <section id="content1a">
                            <!-- Drug Dispensing -->
                            <div class="row">
                                <div class="col-6">
                                    <button onclick="newSample();" class="btn btn-info">New</button>
                                </div>
                                <div class="col-6">
                                    <div class="input-group no-border col-6 pull-right">
                                        <input id="searchSample" type="text" class="form-control"
                                               placeholder="Search...">
                                        <div class="input-group-append">
                                            <div class="input-group-text">
                                                <i class="now-ui-icons ui-1_zoom-bold"></i>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="table-responsive">
                                        <table id="sample" class="table table-striped"></table>
                                    </div>
                                </div>
                            </div>
                        </section>

                        <section id="content2a">
                            <!-- Differentiated Care -->
                            <div class="row">
                                <div class="col-6">
                                    <button onclick="newProcessing();" class="btn btn-info">New</button>
                                </div>
                                <div class="col-6">
                                    <div class="input-group no-border col-6 pull-right">
                                        <input id="searchProcessing" type="text" class="form-control"
                                               placeholder="Search...">
                                        <div class="input-group-append">
                                            <div class="input-group-text">
                                                <i class="now-ui-icons ui-1_zoom-bold"></i>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="table-responsive">
                                        <table id="processing" class="table table-striped"></table>
                                    </div>
                                </div>
                            </div>
                        </section>

                        <section id="content3a">
                            <!-- Drug Prescription -->
                            <div class="row">
                                <div class="col-6">
                                    <button onclick="newDispatch();" class="btn btn-info">New</button>
                                </div>
                                <div class="col-6">
                                    <div class="input-group no-border col-6 pull-right">
                                        <input id="searchDispatch" type="text" class="form-control"
                                               placeholder="Search...">
                                        <div class="input-group-append">
                                            <div class="input-group-text">
                                                <i class="now-ui-icons ui-1_zoom-bold"></i>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="table-responsive">
                                        <table id="dispatch" class="table table-striped"></table>
                                    </div>
                                </div>
                            </div>
                        </section>
