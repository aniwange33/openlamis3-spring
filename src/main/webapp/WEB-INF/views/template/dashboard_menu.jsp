...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <nav class="navbar navbar-expand-lg navbar-absolute bg-default">
                <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navigation2"
                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a href="#" class="nav-link text-center">
                                    <i class="now-ui-icons design_app"></i><br>
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a href="/Prescription_search.action" class="nav-link text-center">
                                    <i class="now-ui-icons business_globe"></i><br>
                            ...
                            <li class="nav-item dropdown pull-right">
                                <a class="nav-link dropdown-toggle text-center" href="#" id="navbarDropdownMenuLink"
                                   data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <i class="now-ui-icons education_paper"></i><br>
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                                    ...
                                    <a data-i18n="patient-on-third-line-regimen-salvage" class="dropdown-item"
                                       id="thirdline" href="/Devolve_search.action">Patients on Third Line Regimen
                                        (Salvage)</a>
                                    ...
                                    <a data-i18n="art-refill-devolvement-report" class="dropdown-item"
                                       id="devolvedsummary" href="/Devolve_search.action">ART Refill Devolvement
                                        Report</a>
                                </div>
                            </li>
                        </ul>
                    ...
                    <div id="clinic" style="display:none;">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown pull-right">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                                    <a class="dropdown-item" id="cd4due" href="/Reporting_month_pmtct.action?formId=1">PMTCT
                                        Monthly Summary</a>
                                    <a class="dropdown-item" id="cd4baseline"
                                       href="/Reporting_period_pmtct.action?formId=1">NIGERIA QUAL Indicators</a>
                                </div>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div id="lab" style="display:none;">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown pull-right">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                                    <a class="dropdown-item" href="/Lab_query_option.action?formId=1">Laboratory Result
                                        Query</a>
                                    <a class="dropdown-item" id="cd4due" href="/Laboratory_page.action">Patients due for
                                        CD4 Count Test</a>
                                    <a class="dropdown-item" id="cd4baseline" href="/Laboratory_page.action">Patients
                                        with current CD4 Count ? baseline value</a>
                                    <a class="dropdown-item" href="/Viral_load.action">Patients due for Viral Load
                                        Test</a>
                                    <a class="dropdown-item" id="viralloadsupressed" href="/Laboratory_page.action">Patients
                                        with current Viral Load &lt; 1000 copies/ml</a>
                                    <a class="dropdown-item" id="viralloadunsupressed" href="/Laboratory_page.action">Patients
                                        with current Viral Load ? 1000 copies/ml</a>
                                    <a class="dropdown-item" href="/Reporting_month_lab.action?formId=1">LAB Monthly
                                        Summary</a>
                                </div>
                            </li>
                        </ul>
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown pull-right">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                                    ...
                                    <a class="dropdown-item" id="cd4due" href="/Converter_page_radet">Generate RADET
                                        File</a>
                                    <a class="dropdown-item" id="cd4baseline" href="/Converter_page_retention">Generate
                                        Cohort Analysis File</a>
                                    <a class="dropdown-item" href="/Converter_page_nigqual">Generate NIGQUAL Files</a>
                                    <a class="dropdown-item" id="viralloadsupressed" href="/Converter_page_ndr">Generate
                                        NDR Files</a>
                                </div>
                            </li>
                        </ul>
