...
<div id="page">
    ...
    <div id="mainPanel">
        ...
        <div id="rightPanel">
            <form id="lamisform" action="biometric_reports">
                    ...
                    <tr>
                        <td>
                                    <span>
                                        ...
                                        <span class="top"
                                              style="margin-bottom: 1px; font-family: sans-serif; font-size: 1.1em;"><strong>Administration >> Events Monitor >> Fingerprint Enrollment Report</strong></span>
                                    </span>
                            <hr style="line-height: 2px"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="topheaders">Fingerprint Enrollment Report</td>
                    </tr>
                </table>
