...
<div class="content col-12 mr-auto ml-auto">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="Home_page">Home_page</a></li>
        <li class="breadcrumb-item"><a href="Clinic_page">Home_page</a></li>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <label for="tab1"><i class="fa fa-stethoscope"></i> ART Clinic</label>

                        <input id="tab2" type="radio" name="tabs">
                        <label for="tab2" id="label2"><i class="fa fa-female"></i> PMTCT</label>

                        <input id="tab3" type="radio" name="tabs">
                        <label for="tab3"><i class="fa fa-flask"></i> Laboratory History</label>

                        <input id="tab4" type="radio" name="tabs">
                        <label for="tab4"><i class="fa fa-medkit"></i> Pharmacy History</label>
                            ...
                            <div class="row">
                                <div id="accordion" role="tablist" aria-multiselectable="true"
                                    ...
                                    <div class="card card-plain">
                                        ...
                                        <div id="anctab" class="collapse" role="tabpanel" aria-labelledby="careheading">
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-6">
                                                        <button onclick="ancRegistration()" class="btn btn-info">New
                                                        </button>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="input-group no-border col-6 pull-right">
                                    ...
                                    <div class="card card-plain">
                                        <div class="card-header" role="tab" id="labourheading">
                                            <a data-toggle="collapse" data-parent="#accordion" href="#labourtab"
                                               aria-expanded="false" aria-controls="labourtab" class="collapsed">
                                                Labour and Delivery <i class="now-ui-icons arrows-1_minimal-down"></i>
                                            </a>
                                        </div>
                                        ...
                                        <div id="labourtab" class="collapse" role="tabpanel"
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-6">
                                                        <button onclick="newDelivery();" class="btn btn-info">New
                                                        </button>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="input-group no-border col-6 pull-right">
                                                ...
                                                <div class="row">
                                                    <div class="col-12 mr-auto ml-auto">
                                                        ...
                                                        <div class="table-responsive">
                                                            ...
                                                            <div id="deliverypager" style="text-align:center;"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card card-plain">
                                        <div class="card-header" role="tab" id="followupheading">
                                            <a class="collapsed" data-toggle="collapse" data-parent="#accordion"
                                               href="#followuptab" aria-expanded="false" aria-controls="followuptab">
                                        ...
                                        <div id="followuptab" class="collapse" role="tabpanel"
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-6">
                                                        <button onclick="newChildFollowup();" class="btn btn-info">New
                                                        </button>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="input-group no-border col-6 pull-right">
                        ...
                        <section id="content3">
                            <div class="row">
                                <div class="col-12">
                                    <div class="table-responsive">
                                        <table id="laboratory" class="table table-striped"></table>
                                    </div>
                                </div>
                            </div>
                        </section>
