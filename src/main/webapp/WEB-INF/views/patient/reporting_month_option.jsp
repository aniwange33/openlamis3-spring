            ...
            $("#ok_button").bind("click", function (event) {
                if (validateForm()) {
                    ...
                    if ($("#formId").html() == 1) {
                        ...
                        if (reportType == "1") {
                            url = "Unbundled_Art_summary.action?reportingMonth=" + $("#reportingMonth").val() + "&reportingYear=" + $("#reportingYear").val();
                        } else if (reportType == "2") {
                            url = "Art_summary.action?reportingMonth=" + $("#reportingMonth").val() + "&reportingYear=" + $("#reportingYear").val();
                        } else if (reportType == "3") {
                            url = "Tx_Ml_summary.action?reportingMonth=" + $("#reportingMonth").val() + "&reportingYear=" + $("#reportingYear").val();
                        }
                        ...
                        <div class="col-md-6 form-group">
                            <div class="form-check form-check-radio">
                                <label class="form-check-label">
                                    <input type="radio" name="reportType" value="1" checked class="form-check-input"/>
                                    <span class="form-check-sign"></span> ART Monthly Summary (PEPFAR)
                                </label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6 form-group">
                            <div class="form-check form-check-radio">
                                <label class="form-check-label">
                                    ...
                                    <span class="form-check-sign"></span> ART Monthly Summary (National)
                                </label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6 form-group">
                            <div class="form-check form-check-radio">
                                <label class="form-check-label">
                                    ...
                                    <span class="form-check-sign"></span> TX ML Monthly Summary
                                </label>
                            </div>
                        </div>
                    </div>
